...
public class BoardDAO_mybatis {
	...
	private static BoardDAO_mybatis BoardDAO_mybatis = new BoardDAO_mybatis();	//static 메모리에 한번만 생성 
	
	public static BoardDAO_mybatis getInstance() {
		return BoardDAO_mybatis;
	}
