...
sendResult로 이동하므로 데이터는 공유하지 않습니다.<br>
주소는 sendResult.jsp가 보인다.<br>
</b></font>
<br>

<font color="blue"><b>
jstlStart.jsp - forwardProc.jsp - forwardResult.jsp 페이지 이동합니다<br>
forwardResult로 이동하므로 데이터는  공유합니다.<br>
주소는 forwardProc.jsp로 보이지만 결과는 forwardResult가 나온다.<br>
</b></font>
<br>
